# Installing iMessage Link Viewer
...
The Xcode project has a hardcoded development team ID (`R3U5TJSP6V`). You will need to:
- Change this to your own Apple Developer Team ID, OR
- Set it to "None" for local-only development
...
Before building, you must update the development team:

**Option A: Use your Apple Developer Team**
1. Open `imessage.xcodeproj` in Xcode
2. Select the "imessage" target in the project navigator
3. Go to "Signing & Capabilities" tab
4. Change "Team" dropdown to your team
5. Xcode will automatically update the bundle identifier if needed

**Option B: Local development only (no team)**
1. Open `imessage.xcodeproj` in Xcode
2. Select the "imessage" target
3. Go to "Signing & Capabilities" tab
4. Set "Team" to "None"
5. Disable automatic signing if prompted

### 3. Build the App
```bash
# Build from command line
xcodebuild -project imessage.xcodeproj -scheme imessage -configuration Debug build
